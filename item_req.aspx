<%@ Page Language="C#" AutoEventWireup="true" CodeFile="item_req.aspx.cs" Inherits="item_req" %>
                                ...
                                <div class="text-center" id="author">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="store-detail-content">
                                            <p>
                                                 <asp:Label ID="desc" runat="server" Text="Label" Visible="False"></asp:Label></p>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                             ...
                                             <div class="form-group">
                                            Click below button to confirm and send request.
                                            </div>
                                            

                                            <div class="form-group">

            <asp:Button ID="Button1" runat="server" onclick="Button1_Click" class="btn btn-drop btn-warning" Text="Click to Confirm" />
                                            </div>
