...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:DropDownList ID="DropDownList2" class="form-control" runat="server">
             ...
             <asp:ListItem>HOME APPLIANCE</asp:ListItem>
                 ...
                 <asp:TextBox ID="TextBox2" class="form-control" runat="server"></asp:TextBox>
                                                        ...
                                                        <th>
                                                         <asp:Button ID="Button1" runat="server" class="btn btn-primary" Text="Search" 
        ...
        <ItemTemplate>
         <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <a href="#"><img src="<%# DataBinder.Eval(Container, "DataItem.pic_1") %>" class="img-responsive"></a>
                                    </div>
                                    <div class="col-sm-7">
                                        <h4 class="title-store">
                                            <strong><a href="#"><%# DataBinder.Eval(Container, "DataItem.name") %></a></strong>
                                        </h4>
                                        <hr>
                                        <p><%# DataBinder.Eval(Container, "DataItem.details") %></p>
                                        <p>
                                            <a href="#" class="btn btn-default" disabled><%# DataBinder.Eval(Container, "DataItem.condition") %></a>
                                            <a href="details.aspx?item_id=<%# DataBinder.Eval(Container, "DataItem.item_id") %>&item_del=0" class="btn btn-warning pull-right">Buy Now</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <ProgressTemplate>
    <asp:Image ID="load" runat="server" ImageUrl="~/img/loading11.gif" />
    </ProgressTemplate>
    </asp:UpdateProgress>
