<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thanks_sent.aspx.cs" Inherits="thanks_sent" %>
        ...
        <asp:Panel ID="Panel1" runat="server">
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                              Below are all the thanks note which you have sent to donators.
                               </header>
...
<ItemTemplate>
 <tbody>
                                    <tr>
                                        ...
                                        <asp:Label ID="fb_mem_id" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.fb_mem_id") %>' Visible="False"></asp:Label>
             <asp:Label ID="Label5" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.req_id") %>' Visible="false"></asp:Label>        
        <asp:Label ID="date" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.date") %>' Visible="false"></asp:Label>        
          ...
          <asp:Label ID="Label8" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.country") %>'></asp:Label>,
           ...
           <asp:Label ID="Label9" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.city") %>'></asp:Label></td>
                                        ...
                                        <td>
                                           ...
                                           <asp:LinkButton ID="LinkButton1" class="btn btn-success btn-xs" CommandName="request_coming" runat="server" OnClientClick="#myModal">View Details</asp:LinkButton>
...
<FooterTemplate>
    ...
    <asp:Panel ID="Panel2" runat="server">
     <div class="panel panel-info">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="text-center" id="author">
                                    <img src="<%=u_pic %>">
                                    <h3><%=f_name %></h3>
                                    <small class="label label-warning"><%=country %>,<%=city %></small>
                                    <p>You can share this story on Facebook click on below FSHARE button.</p>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <ul id="myTab" class="nav nav-pills">
                                    ...
                                    <li class=""><a href="#detail" data-toggle="tab">Thanks Note</a></li>
        ...
        <!-- end:main and start of modal pop up -->
