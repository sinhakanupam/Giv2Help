    ...
    <link rel="stylesheet" href="css/style.css">
     ...
     <script type="text/javascript">
         ...
         function uploadComplete(sender, args) {
             ...
             var div2 = document.getElementById('panel2');
 ...
 <div class="col-md-5">
  <div id="panel2" style="display:'block'">
   ...
   <div class="well well-warning">
                            ...
                            Use form to upload product image and enter details about it.
                        </div>
  ...
  <div id="panel1" style="visibility:hidden">
                           ...
                           <asp:TextBox ID="item_name" class="form-control" runat="server"></asp:TextBox>
                               ...
                               <asp:ListItem>HOME APPLIANCE</asp:ListItem>
                               <asp:ListItem>COMPUTERS</asp:ListItem>
                               <asp:ListItem>BOOKS</asp:ListItem>
                               <asp:ListItem>AUTOMOBILE</asp:ListItem>
                               </asp:DropDownList>
                                          <p class="help-block">Select Category in which product belong.</p>
                                      </div>
                                  </div>
                                  <div class="form-group has-error">
                                      <label class="col-lg-2 control-label">Description</label>
                                      <div class="col-lg-10">
                                           <asp:TextBox ID="item_desc" class="form-control" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox>
                          
                                          <p class="help-block">Describe the item in not more then 100 words.</p>
                                      </div>
                                  </div>
                                  <div class="form-group has-warning">
                               ...
                               <asp:ListItem>NEW</asp:ListItem>
                                          ...
                                          <p class="help-block">Is it Used or New?</p>
                                      </div>
                                  </div>
                                   ...
                                   <div class="form-group has-error">
                                      ...
                                      <div class="col-lg-10">
                                           <asp:TextBox ID="area" class="form-control" runat="server"></asp:TextBox>
                          
                                          <p class="help-block">Area where you live in the city?</p>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                   ...
                                   <asp:Button class="btn btn-primary" ID="Button1" runat="server" Text="UPLOAD" 
