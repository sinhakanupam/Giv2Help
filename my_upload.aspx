<%@ Page Language="C#" AutoEventWireup="true" CodeFile="my_upload.aspx.cs" Inherits="my_upload" %>
            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="index.html"><i class="fa fa-cubes"></i> <strong>Give</strong>2<strong>People</strong></a>
                    </div>
                    <!-- end:navbar-header -->
        ...
        <asp:Panel ID="Panel1" runat="server">
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                              Below are all the item which you have uploaded for donation donation.
                               </header>
...
<table class="table table-striped table-advance table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fa fa-bookmark"></i> Condition</th>
                                        <th><i class=" fa fa-edit">Details</i></th>
                                        <th></th>
                                    </tr>
                                </thead>
</HeaderTemplate>
...
<ItemTemplate>
 <tbody>
                                    <tr>
                                        ...
                                        <asp:Label ID="item_id" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.item_id") %>' Visible="False"></asp:Label>
           
                                 
                                 
                                 <td><asp:Label ID="Label7" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.name") %>'></asp:Label></td>
                                 <td><asp:Label ID="Label6" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.cat") %>'></asp:Label></td>
                                 
                                 <td>
          <asp:Label ID="Label8" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.condition") %>'></asp:Label></td>
       
          <asp:Label ID="Label9" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.date") %>' Visible="False"></asp:Label>
            ...
            <div class="container">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                   <div class="footer-widget">
                        <h1 class="page-header">Fiture <strong>Tentang </strong></h1> 
