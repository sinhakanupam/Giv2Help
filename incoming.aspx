...
<table class="table table-striped table-advance table-hover">
                                <thead>
                                    <tr>
                                        <th><i class="fa fa-bullhorn"></i> Owner</th>
                                        <th class="hidden-phone"><i class="fa fa-question-circle"></i> Product</th>
                                        <th><i class="fa fa-bookmark"></i> Owner Location</th>
...
<ItemTemplate>
 <tbody>
     ...
     <td><span class="label label-info label-mini"><asp:Label ID="Label40" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.status") %>'></asp:Label></asp:Label></span></td>
...
<FooterTemplate>
        ...
        <div class="panel panel-info">
            ...
            <asp:Panel ID="notif_warn" runat="server">
            

                         <div class="well well-warning">
                            <h3>Pending Approval from Owner</h3>

                            </asp:Panel>

                            <asp:Panel ID="notif_approve" runat="server">
            

                         <div class="well well-success">
                            <h3>Congratulations your request been have approved. </h3>

                            <h5>Thank him by sharing some picture of happines with this product.</h5>
                            <br />
                            <a href="#myModal" data-toggle="modal" class="btn btn-drop btn-warning">
                                    Send Thanks Note
                                    </a>
            ...
            <div class="col-lg-6 col-md-6">
             ...
             <div class="panel panel-info">
                ...
                <h4>You will see details once your request is approved by Owner</h4>
                </asp:Panel>
                          ...
                          <div class="panel panel-info panel-drop">
                            <div class="panel-heading">
                                <header class="panel-title">
                                    Cause for which requester need product.
                                </header>
            ...
            <ContentTemplate>
                <asp:Panel ID="Panel5" runat="server">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Thank him or her by sharing smiles you see </h4>
                                            </div>
                                            <div class="modal-body">
                                                 ...
                                                 <div class="form-group">
                                                        <label for="exampleInputEmail1">Your thanks note.</label>
                                                        
                                                    <asp:TextBox ID="TextBox1" class="form-control" runat="server" Rows="4" TextMode="MultiLine"></asp:TextBox>
                                                        
                                                          </div>
  <label for="exampleInputEmail1">Share pics of happiness.</label>
        ...
        <img src="" id="img4" alt="" height="100" width="100" />
                ...
                <asp:Panel ID="Panel6" runat="server" Visible="False">
                 ...
                 <div class="modal-header">
                                            ...
                                            <div class="form-group">
                                             Thanks, Your note sent to donator
                                             </div>


                     <asp:Button ID="Button2" runat="server" onclick="Button2_Click" class="btn btn-drop btn-warning" Text="Okay" />
